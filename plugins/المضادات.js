...
rows: [{ header: `🎉 الترحيب ${m.isGroup ? chat.welcome ? '✅' : '❌' : `⚠️`}`, title: "", id: `${usedPrefix + command} ترحيب`, description: `رسالة ترحيب للأعضاء الجدد في الجروبات\n` }, 
...
{ header: `🟢 منع الفيك ${m.isGroup ? chat.antilink ? '✅' : '❌' : `⚠️`}`, title: "", id: `${usedPrefix + command} مضادالفيك`, description: `دخول رقم فيك (افتراضي)، هيتم طرده تلقائي من الجروب...\n` }, 
{ header: `🔔 التنبيهات ${m.isGroup ? chat.antilink ? '✅' : '❌' : `⚠️`}`, title: "", id: `${usedPrefix + command} كشف`, description: `تنبيهات من الأنشطة داخل الجروب\n` }, 
...
{ header: `🗑️ منع الحذف ${m.isGroup ? chat.antilink ? '✅' : '❌' : `⚠️`}`, title: "", id: `${usedPrefix + command} مضادحذف`, description: `أي رسالة محذوفة هتتبعت تاني للشات أو الجروب\n` }, 
...
{ header: `🆙 الترقية التلقائية ${m.isGroup ? chat.antilink ? '✅' : '❌' : `⚠️`}`, title: "", id: `${usedPrefix + command} مستوي`, description: `ترقية الجميع تلقائيًا؛ (يشمل مكافآت عند الترقية)\n` }, 
{ header: `🙃 الدردشة الآلية ${m.isGroup ? chat.antilink ? '✅' : '❌' : `⚠️`}`, title: "", id: `${usedPrefix + command} سمسمي`, description: `البوت هيبدأ يتكلم مع الجميع في الجروب.\n` }, 
...
{ header: `⛔ تقييد ${m.isGroup ? chat.antilink ? '✅' : '❌' : `⚠️`}`, title: "", id: `${usedPrefix + command} تقييد`, description: `تفعيل وظيفة لإضافة أو إزالة الأشخاص في الجروبات\n` }, 
...
{ header: `⚜️ جروبات فقط ${m.isGroup ? chat.antilink ? '✅' : '❌' : `⚠️`}`, title: "", id: `${usedPrefix + command} عام`, description: `السماح باستخدامه في الدردشات الجماعية فقط\n` }, 
{ header: `✅ القراءة التلقائية ${m.isGroup ? chat.antilink ? '✅' : '❌' : `⚠️`}`, title: "", id: `${usedPrefix + command} الصحين`, description: `ترك الرسائل أو الشات كمقروءة.\n` },
...
case 'مضادحذف': case 'antieliminar': case 'delete':
if (m.isGroup) {
if (!(isAdmin || isOwner)) {
global.dfail('admin', m, conn)
throw false
...
case 'مستوي': case 'autonivel': case 'nivelautomatico':
if (m.isGroup) {
if (!(isAdmin || isOwner)) {
global.dfail('admin', m, conn)
throw false
...
case 'antiinternacional': case 'antinternacional': case 'antinternational': case 'مضادالفيك': case 'antifalsos': case 'antivirtuales': case 'antiextranjeros':		
if (m.isGroup) {
if (!(isAdmin || isOwner)) {
global.dfail('admin', m, conn)
throw false
...
case 'عام': case 'grouponly': case 'sologrupos':
isAll = true
if (!isROwner) {
global.dfail('rowner', m, conn)
throw false
