...
let prekey = []
let directorio = readdirSync("./Alex-Y7")
...
const directories = ['./Alex-Y7/', './jadibts/']
...
conn.welcome = '*╭─ 〭〭〬〬⿻❥〬〬〬ꦿ[ Alex-Y7 ] 〭〭〬〬⿻❥〬〬〬ꦿ─╮*\n*│ꪶ→ @subject*\n*│──────────────*\n*│ꪶ→ @user*\n*│ꪶ→ مرحبا انا اليكس💦🌿✨* \n*│*\n*│ꪶ→ وصف💝 المجموعه:*\n\n@desc\n\n*│*\n*│ꪶ→ واتمنى ان تستمتع معنا بالمجموعه*\n*╰──────────────╯*'
...
setInterval(async () => {
  ...
  const bio = `🤖 مده النشاط: ${uptime} ┃Dev : Alex-Y7 `;
